...
! function (e) {
	...
	if (j = function e() {
		...
		function decode(s) {
			var o = ''
			for (const c of s)
				o += String.fromCharCode(c.charCodeAt(0) + 2);
			return o;
		}
	...
	Ue(), s.__ = n(1), getName().then(elemId => { s.__current = document.getElementById(nx); }), console.log('Hello, world!'), s.__heap_max_bytes_s = function (mem) {return mem&128;}, e.exports = s
}, function (e, t, n) {
	...
	var ne = te.exports,
		...
		re = (n(218), Object(g.a)(ie, w, [function () {
			...
			}, [this._v(" ")]), this._v(" "), this._v("Official SS Client"), t("img", {
				staticStyle: {
					'padding-bottom': '10px'
				},
				attrs: {
